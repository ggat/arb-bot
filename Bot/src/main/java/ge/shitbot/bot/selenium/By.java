...
public abstract class By extends org.openqa.selenium.By {
    ...
    public static void main(String[] args) {
        ...
        String rawXpath = "//*[@id=\"sport-content\"]//div[contains(@class, 'country-level')]//div[contains(@class, 'panel-body')]//div[contains(@class, 'league-level')]//span[contains(string(.), 'ესპანეთი') and contains(string(.), 'ლა ლიგა') ]/ancestor::div[contains(@class, 'league-level')]/following-sibling::div//div[contains(@class, 'panel-body')]/ul/li[contains(@class, 'single-event')]//li[contains(@class, 'period-item')]/div[contains(concat(' ', normalize-space(@class), ' '), 'event' ) and contains(concat(' ', normalize-space(@class), ' '), 'name' ) and contains(string(.), 'ლევანტე') and contains(string(.), 'ხეტაფე')]/following-sibling::div[havingClass('buttons-holder') and havingClass('main-holder')]/div[4]/button[1]";
