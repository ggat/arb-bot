...
(function() {
    ...
    AbstractChosen = (function() {
        ...
        AbstractChosen.prototype.winnow_results = function() {
            var i, len, option, ref, results, results_group, searchText, words;
        ...
        AbstractChosen.prototype.split_search_text = function(text) {
            var i, len, ref, word, words;
            words = [];
            ref = text.toLowerCase().split(' ');
            for (i = 0, len = ref.length; i < len; i++) {
                word = ref[i];
                if (word.trim() !== "") {
                    words.push(word);
        ...
        AbstractChosen.prototype.highlight_search_text = function(text, words) {
            var highlight_offset, i, len, startpos, word;
  ...
  Chosen = (function(superClass) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.inherit_select_classes && this.form_field.className) {
        container_classes.push(thgis.form_field.className);
      }
      if (this.is_rtl) {
