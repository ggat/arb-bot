...
public class ChainUtilsTest {
    ...
    public void testAdaptChains() {
        ...
        List<ge.arb-bot.daemon.analyze.models.Chain> adaptedChains = ChainUtils.adaptChains(dbChains);

        assertEquals(5, adaptedChains.size());

        for(ge.arb-bot.daemon.analyze.models.Chain chain : adaptedChains) {
